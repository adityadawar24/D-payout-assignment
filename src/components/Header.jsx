const Header = () => {
  return (
    <div className="flex w-[1216px] px-[32px] py-[12px] items-center gap-[16px] border-b border-[#D9D9D9] bg-[#fff]">
      <div className="flex font-inter items-center gap-[16px] flex-grow flex-shrink-0 flex-basis-0">
        <p className="text-[15px] font-normal leading-[22px] text-[#1A181E]">
          Payments
        </p>
        <div className="flex items-center gap-[6px] text-[#4D4D4D]">
          <div>
            <svg
              ...
              fill="none"
            >
              <g clipPath="url(#clip0_51639_2522)">
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
              ...
              <defs>
                <clipPath id="clip0_51639_2522">
                  <rect width="14" height="14" fill="white" />
                </clipPath>
              </defs>
            </svg>
          </div>
          <p className="text-[12px] font-normal leading-[16px]">How it works</p>
        </div>
      </div>

      <div>
        <div className="flex w-[400px] px-[16px] py-[9px] items-center gap-[8px] flex-shrink-0 self-stretch bg-[#F2F2F2] rounded-[6px]">
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              ...
              fill="none"
            >
              <g clipPath="url(#clip0_51639_2526)">
                <path
          ...
          <input
            ...
            className="w-full bg-inherit font-inter text-[#808080] text-[15px] font-normal leading-[22px] outline-none"
          />
        </div>
      </div>

      <div className="flex justify-end items-start gap-[8px] flex-grow flex-shrink-0 flex-basis-0">
        <div className="flex items-start gap-[12px]">
          <div className="w-[40px] h-[40px] flex-shrink-0 rounded-full flex items-center justify-center bg-[#E6E6E6] cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
          ...
          <div className=" cursor-pointer">
            <svg
              ...
              fill="none"
            >
              <g clipPath="url(#clip0_51639_2537)">
