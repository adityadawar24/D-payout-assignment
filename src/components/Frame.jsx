const Frame = () => {
  return (
    <div className="flex w-[1152px] flex-col items-start gap-[32px]">
      <div className="flex flex-col items-start gap-[24px] self-stretch">
        <div className="flex flex-col items-start gap-[20px] self-stretch">
          <div className="flex justify-between items-center self-stretch">
            <p className="font-inter text-[20px] leading-[28px] font-normal">
              Overview
            </p>
            <div className="flex items-center gap-[16px]">
              <select className="w-[137px] h-[36px] border ">
        ...
        <div className="flex justify-start gap-[20px] self-stretch">
          ...
          <div className="flex justify-center items-center gap-[24px] flex-grow flex-shrink-0 flex-basis-0">
            <div className="flex p-[20px] flex-col items-start gap-[16px] flex-grow flex-shrink-0 flex-basis-0 shadow-md bg-[#fff] rounded-[8px]">
              <div className="flex flex-col items-start gap-[16px] self-stretch">
                <div className="flex items-center gap-[8px]">
                  <p className="font-inter text-[16px] text-[#4D4D4D] font-normal leading-[24px]">
                    Amount received
                  </p>
                </div>
                <div className="flex items-center gap-[16px] self-stretch">
                  <div className="flex justify-between items-center flex-grow flex-shrink-0 flex-basis-0">
                    <p className="font-inter text-[32px] text-[#1A181E] font-normal leading-[38px]">
                      ₹23,92,312.19
                    </p>
                  </div>
                </div>
      ...
      <div className="flex flex-col items-start gap-[20px]">
        <label className="font-inter text-[20px] leading-[28px] font-normal">
          Transactions | This Month
        </label>

        <div className="flex pt-[12px] pr-[12px] pb-[24px] pl-[12px] flex-col items-end w-[1152px] rounded-[8px] shadow-md">

          <div className="flex flex-col items-end gap-[12px]">
            <div className="flex justify-between items-center self-stretch w-[1128px]">
              <div className="flex w-[248px] items-start">
                <div className="flex px-[16px] py-[10px] items-center gap-[8px] flex-grow flex-shrink-0 flex-basis-0 rounded-[4px] border border-[#D9D9D9] bg-[#fff]">
                  <div>
                    <svg
                      ...
                      fill="none"
                    >
                      <g clip-path="url(#clip0_51639_3685)">
                        <path
                  ...
                  <input
                    type="text"
                    className="font-inter text-[14px] font-normal leading-[20px] outline-none"
                ...
                <div className="flex items-center gap-[12px]">
                  <div className="flex justify-end items-end gap-[12px]">
                    <div className="flex items-end gap-[12px]">
                      <button className="flex px-[12px] py-[6px] items-center gap-[6px] rounded-[4px] border border-[#D9D9D9] bg-[#fff]">
                        Sort
                        <div>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                      ...
                      <button className="w-[36px] h-[36px]">
                        <div className="w-[36px] h-[36px] flex-shrink-0 rounded-[4px] border border-[#D9D9D9] flex items-center justify-center">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="20"
                            height="20"
            ...
            <div className="flex w-[1128px] px-[12px] py-[14px] items-center gap-[40px] h-[40px] bg-[#F2F2F2] rounded">
              <div className="flex flex-col justify-center items-start gap-[-1px] flex-grow flex-shrink-0 flex-basis-0 w-[60px]">
                ...
                <div className="flex items-start gap-[90px]"></div>
              </div>

              <div className="flex flex-col justify-center items-start gap-[-1px] flex-grow flex-shrink-0 flex-basis-0">
                <div className="flex items-center gap-[4px]">
                  <div className="flex items-center gap-[16px]">
                    <div className="flex items-center gap-[12px]">
                      <div className="flex flex-col items-start justify-center gap-[2px]">
              ...
              <div className="flex flex-col justify-center items-end gap-[-1px] flex-grow flex-shrink-0 flex-basis-0">
                <div className="flex items-center gap-[4px]">
                  <div className="flex items-center gap-[16px]">
                    <div className="flex items-center gap-[12px]">
                      <div className="flex flex-col items-start justify-center gap-[2px]">
            ...
            <div className="flex w-[1128px] px-[12px] py-[14px] items-center gap-[40px] h-[40px] border-b border-[#e6e6e6]">
              <div className="flex flex-col justify-center items-start gap-[-1px] flex-grow flex-shrink-0 flex-basis-0 w-[45px]">
                <div className="flex items-center gap-[4px]">
                  <div className="flex items-center gap-[16px]">
                    <div className="flex items-center gap-[12px]">
                      <div className="flex flex-col items-start justify-center gap-[2px]">
                        <div className="flex items-center gap-[8px]">
                          <div className="flex items-center gap-[4px]">
                            <p className="font-inter text-[14px] text-[#146EB4] font-normal leading-[20px]">
                              #281209
                            </p>
                          </div>
                        </div>
              ...
              <div className="flex flex-col justify-center items-end w-[50px] gap-[-1px] flex-grow flex-shrink-0 flex-basis-0 mr-20">
                <div className="flex items-center gap-[4px]">
                  <div className="flex items-center gap-[16px]">
                    <div className="flex items-center gap-[12px]">
                      <div className="flex flex-col items-start justify-center gap-[2px]">
            ...
            <div className="flex flex-col items-center gap-[24px]">
              <div className="flex w-[1128px] h-[48px] px-[12px] py-[14px] gap-[40px] items-center border-b border-[#e6e6e6]">
                <div className="flex flex-col justify-center items-start gap-[-1px] flex-grow flex-shrink-0 flex-basis-0 w-[45px]">
                  <div className="flex items-center gap-[4px]">
                    <div className="flex items-center gap-[16px]">
                      <div className="flex items-center gap-[12px]">
                  ...
                  <div className="flex flex-col justify-center items-center gap-[24px]">
                    <div className="flex flex-col items-center gap-[24px]">
                      <div className="flex items-center gap-[24px]">
                        <div className="flex pt-[6px] pr-[12px] pb-[6px] pl-[6px] justify-center items-center gap-[6px] rounded-[4px] border border-[#D9D9D9] bg-[#fff]">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="18"
                            height="18"
                          ...
                          <button className="flex items-start gap-[8px] font-inter font-normal text-[14px] leading-[20px] text-center">
                            Previous
                          </button>
                        </div>
                        <div className="flex items-start gap-[8px]">
                          <div className="flex w-[28px] h-[28px] py-[2px] flex-col justify-center rounded-[4px] items-center gap-[8px]">
                          ...
                          <div className="flex w-[28px] h-[28px] py-[2px] flex-col justify-center rounded-[4px] text-white items-center gap-[8px] bg-[#146EB4]">
                            <p className="font-inter text-[14px] font-normal leading-[20px] text-center">
                              10
                            </p>
                          </div>

                          <div className="flex w-[28px] h-[28px] py-[2px] flex-col justify-center items-center  gap-[8px]">
                            <p className="font-inter text-[14px] font-normal leading-[20px] rounded-[4px] text-center">
                              11
                            </p>
                          </div>
                          <div className="flex w-[28px] h-[28px] py-[2px] flex-col justify-center items-center  gap-[8px]">
                        ...
                        <div className="flex pt-[6px] pr-[6px] pb-[6px] pl-[12px] justify-center items-center gap-[6px] rounded-[4px] border border-[#D9D9D9] bg-[#fff]">
                          <div className="flex items-start gap-[8px]">
                            <p>Next</p>
                          </div>
                          <svg
